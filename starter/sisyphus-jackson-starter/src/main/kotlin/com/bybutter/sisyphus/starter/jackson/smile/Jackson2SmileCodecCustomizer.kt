...
class Jackson2SmileCodecCustomizer : CodecCustomizer {
    override fun customize(configurer: CodecConfigurer) {
        configurer.defaultCodecs().jackson2SmileEncoder(Jackson2SmileEncoder(Json.mapper, *DEFAULT_SMILE_MIME_TYPES))
        configurer.defaultCodecs().jackson2SmileDecoder(Jackson2SmileDecoder(Json.mapper, *DEFAULT_SMILE_MIME_TYPES))
    }
