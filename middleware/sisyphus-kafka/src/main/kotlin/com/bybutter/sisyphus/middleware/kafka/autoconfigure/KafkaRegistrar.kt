...
import com.bybutter.sisyphus.middleware.kafka.ConsumerLifecycle
...
import com.bybutter.sisyphus.middleware.kafka.MessageConsumer
            ...
            val consumerDefinition = BeanDefinitionBuilder.genericBeanDefinition(SmartLifecycle::class.java) {
                ...
                ConsumerLifecycle(
                    beanFactory.getBean(KafkaResourceFactory::class.java)
                        ...
                        .also {
                            logger.info("Kafka listener (${annotation.groupId}) registered on topic '${annotation.topic}(${annotation.filter})'.")
                        },
                    listener
                )
            }.beanDefinition
