...
object DeploymentSupport : KubernetesResourceSupport<V1Deployment> {
    ...
    override fun patchResourceCall(resource: KubernetesResource<V1Deployment>, patch: V1Patch): Call {
    ...
    override fun updateMetadata(resource: KubernetesResource<V1Deployment>, k8sResource: V1Deployment) {
    ...
    override fun checkReady(resource: KubernetesResource<V1Deployment>, task: Task, k8sResource: V1Deployment): Boolean {
