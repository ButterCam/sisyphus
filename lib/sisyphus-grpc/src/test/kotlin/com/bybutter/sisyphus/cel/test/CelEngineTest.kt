...
import com.bybutter.sisyphus.cel.CelMacro
import com.bybutter.sisyphus.cel.CelRuntime
import com.bybutter.sisyphus.cel.CelStandardLibrary
...
class CelEngineTest {
    ...
    fun `test times cel eval`() {
        val engine = CelEngine(mapOf())
        engine.assertEvalResult("""timestamp('2020-01-01T08:00:00.000Z') + duration('100.0s')""", Timestamp(2020, 1, 1, 8, 1, 40, zoneId = ZoneId.of("UTC")))
        engine.assertEvalResult("""duration('100.0s') + timestamp('2020-01-01T08:00:00.000Z')""", Timestamp(2020, 1, 1, 8, 1, 40, zoneId = ZoneId.of("UTC")))
        engine.assertEvalResult("""timestamp('2020-01-01T08:00:00.000Z') - duration('100.0s')""", Timestamp(2020, 1, 1, 7, 58, 20, zoneId = ZoneId.of("UTC")))
    ...
    fun `test compare cel eval`() {
        ...
        engine.assertEvalResult("""timestamp('2020-01-01T08:00:00.000Z') == timestamp('2020-01-01T08:00:00.000Z') """, true)
