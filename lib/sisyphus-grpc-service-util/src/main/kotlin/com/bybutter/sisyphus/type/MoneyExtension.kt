...
import com.bybutter.sisyphus.type.internal.MutableMoney
...
fun Money.convertTo(currencyCode: String, fallbackCurrencyCode: String = ""): Money {
    ...
    val current =
        BigDecimal.valueOf(this.units) * BigDecimal.valueOf(nanosPerUnit) + BigDecimal.valueOf(this.nanos.toLong())
