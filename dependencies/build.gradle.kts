...
dependencies {
    ...
    api(platform("io.grpc:grpc-bom:1.40.1"))
    ...
    constraints {
        ...
        api("com.google.api.grpc:proto-google-common-protos:2.5.0")
        ...
        api("org.jooq:jooq:3.15.2")
        api("org.mongodb:mongodb-driver-reactivestreams:4.3.2")
