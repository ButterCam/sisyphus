...
dependencies {
    ...
    constraints {
        ...
        api("com.palantir.gradle.docker:gradle-docker:0.26.0")
        ...
        api("io.seata:seata-common:1.4.2")
        api("io.seata:seata-config-core:1.4.2")
        api("io.seata:seata-core:1.4.2")
        api("io.seata:seata-rm:1.4.2")
        api("io.seata:seata-rm-datasource:1.4.2")
        api("io.seata:seata-sqlparser-core:1.4.2")
        api("io.seata:seata-sqlparser-druid:1.4.2")
        api("io.seata:seata-spring:1.4.2")
        api("io.seata:seata-tm:1.4.2")
        api("io.seata:seata-serializer-seata:1.4.2")
        api("io.seata:seata-serializer-protobuf:1.4.2")
        api("io.seata:seata-grpc:1.4.2")
    }
}