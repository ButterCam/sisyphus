...
dependencies {
    ...
    api(platform("com.google.protobuf:protobuf-bom:3.21.1"))
    ...
    api(platform("org.apache.rocketmq:rocketmq-all:4.9.3"))
    api(platform("org.jetbrains.kotlin:kotlin-bom:1.7.0"))
    ...
    constraints {
        ...
        api("com.google.api.grpc:proto-google-common-protos:2.9.0")
