plugins {
    ...
    `kotlin-dsl`
    id("idea")
    id("com.bybutter.sisyphus.project") version "0.0.9"
}

dependencies {
    implementation(platform("com.bybutter.sisyphus:sisyphus-dependencies:0.0.9"))
    ...
    implementation("org.jetbrains.kotlin:kotlin-allopen:1.4.10")
